...
#     bash benchmarks/scripts/orchestrators/run_qwen35_canonical.sh [SMOKE]
...
if [[ "$SMOKE" == "SMOKE" ]]; then
    ...
    MODEL_KEYS=("qwen3.5-9b")
    RESULT_DIRS=("qwen3.5-9b")
    MODEL_QUANTS=("bf16")
    MODEL_PATHS=("/home/mozarcik/models/qwen3.5-9b")
    MODEL_HF_NAMES=("Qwen/Qwen3.5-9B")
    MODEL_CELLS=("1:10 1:25 1:50 1:100 1:200 1:500 1:1000")
    GLOBAL_LOG_DIR="$REPO_ROOT/benchmarks/results/_qwen35_canonical_logs"
fi

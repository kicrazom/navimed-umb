#!/usr/bin/env bash
# =============================================================================
# run_n1_anchor_gapfill.sh
#
# N=1 ANCHOR — DOPELNIENIE LUKI PAR ABLACYJNYCH (2026-08-29).
#
# Czerwcowa kampania N=1 zmierzyla dla kazdej pary BF16<->AWQ tylko JEDNEGO
# czlonka: Bielik-4.5B ma BF16 bez AWQ, PLLuM-8B/12B maja AWQ bez BF16.
# Iloraz precyzji przy N=1 byl wiec niepoliczalny (F9 nie pokazywala N=1).
# Ten skrypt dokłada brakujace 3 configi x {TP1,TP2} x 10 rep = 60 runow.
# USTAWIENIA IDENTYCZNE z oryginalem — inaczej komorki nie sa porownywalne.
#
...
GLOBAL_LOG_DIR="$RESULTS_ROOT/_n1_anchor_gapfill_logs"

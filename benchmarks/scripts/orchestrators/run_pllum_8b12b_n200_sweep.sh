...
MAX_LEN=8192
UTIL=0.90
N_LADDER=(200)                   # UNIFORMITY: add n200 (70B/paper §3.3 canonical point) to 8B/12B
TP_LADDER=(1 2)
REPS=10
COOLDOWN_S=30
PER_RUN_TIMEOUT_S=900            # n200 is a fast mid-ladder point; caught as rc=124, never kills
FULL_LADDER="5,10,25,50,100,200,250,500,1000"
...
PROGRESS_LOG="/tmp/pllum-8b12b-n200-progress.log"
GLOBAL_LOG_DIR="$REPO_ROOT/benchmarks/results/_pllum_n200_logs"
...
write_embargo_header() {
    {
        ...
        echo "# Sweep: Run-3 UNIFORMITY n200 {8B,12B}, TP={1,2}, N={200}, reps=10"

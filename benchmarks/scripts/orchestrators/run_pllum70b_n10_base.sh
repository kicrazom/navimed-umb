...
# BASE variant 2026-06-03: completes the full 8×70B AWQ family for Paper #1.
# chat×{2412,2508,2512} + instruct×{2412,2508,2512} already have n=10 (6/8 done);
# base has only 2 versions (no base-2512), so these two close the family to 8/8.
MODEL_DIRS=(
...
GLOBAL_LOG_DIR="$RESULTS_ROOT/_pllum70b_base_logs"
